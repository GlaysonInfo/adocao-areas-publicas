...
/**
 * Regrava os storages usando os normalizadores atuais de cada módulo.
 * Isso reaproveita o saneamento de texto e corrige dados antigos do localStorage.
 */
...
// Exposição opcional para uso no DevTools durante desenvolvimento.
declare global {
  interface Window {
